...
from .LETNet_module.transformer import TransBlock
from .LETNet_module.patch import reverse_patches
...
class LETNet(nn.Module):
    def __init__(self, in_ch=3, block_1=3, block_2=12, block_3=12):
        super().__init__()
        self.init_conv = nn.Sequential(
            Conv(in_ch, 32, 3, 1, padding=1, bn_acti=True),
