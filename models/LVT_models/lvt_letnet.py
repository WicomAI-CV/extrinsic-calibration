...
class TransCalib_lvt_letnet_july19(nn.Module):
    def __init__(self, model_config, trans_norm=False):
        super(TransCalib_lvt_letnet_july19, self).__init__()
        ...
        self.rgb_branch = LETNet()
        
        self.depth_branch = LETNet(in_ch=1)
...
class default_regression_head(nn.Module):
    def __init__(self, dropout=0.0):
        ...
        self.fc = nn.Sequential(nn.Linear(5120,1024),
                                nn.ReLU(),
